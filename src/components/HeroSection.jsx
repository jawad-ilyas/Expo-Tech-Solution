        ...
        lg:flex lg:flex-col lg:items-start  lg:rounded-3xl  text-light bg-dark lg:pt-28 lg:px-24 font-inter |  mx-5 rounded-3xl  px-6 py-12'>
            ...
            <div className='lg:flex lg:justify-between 2xl:px-32 sm:flex-row'>
                <div className='lg:w-1/2 sm:w-full'>
                    <h1 className='lg:text-6xl sm:text-center sm:text-3xl  lg:leading-snug lg:font-bold text-center '> <span className='2xl:block '>Compiling  Code</span>   With <span className="text-primary">High-Tech </span> <br></br>Flames</h1>
                </div>

                <div className='lg:w-1/2  sm:w-full lg:pt-8 lg:px-24 no| w-full'>

                    <p className='lg:text-xl  text-lightGray lg:leading-8 no| text-center text-base mt-4 '> Our diverse range of services is designed to help your business succeed in the ever-evolving digital world.</p>
