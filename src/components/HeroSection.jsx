...
function HeroSection() {
    return (
        ...
        lg:flex lg:flex-col lg:items-start  lg:rounded-3xl  text-light bg-dark lg:pt-28 lg:px-24 font-inter  no |  mx-4 rounded-3xl  px-6 py-12 | sm:mx-6 | md:mx-8'>

            <div className='lg:flex lg:justify-between 2xl:px-32 sm:flex-row'>
                <div className='lg:w-1/2 sm:w-full'>
                    <h1 className='lg:text-6xl sm:text-center  lg:leading-snug lg:font-bold text-center no | text-4xl font-semibold leading-snug  | sm:text-5xl  sm:leading-snug'> <span className='2xl:block block | md:inline-block'>Compiling  Code</span>   With <span className="text-primary md:inline-block">High-Tech </span> Flames</h1>
                </div>
