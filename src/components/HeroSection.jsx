...
function HeroSection() {
    return (
        <div className='mt-32 text-light bg-dark font-inter bg-[url("/src/assets/hero-wave.png")] bg-no-repeat bg-cover mx-4 rounded-3xl px-6 py-12 sm:mx-6 md:mx-8 lg:w-full | xl:w-11/12 xl:mx-auto |  2xl:10/12'>
