...
function JoinOurTeamSection() {
    return (
        <div className=' bg-lightBg no | mx-4 | sm:mx-6  | md:mx-8'>
            <div className='xl:w-11/12 mx-auto 2xl:w-8/12'>

                <div className='no | flex flex-col justify-between items-start  | lg:flex-row'>
                    <div className='2xl:w-5/12 xl:w-5/12 py-5 mb-sm-2 mb-md-3 mb-lg-5 mt-3 mt-sm-4 no | px-3 pt-10 | lg:w-6/12'>
                    ...
                    <div className='2xl:w-7/12 xl:w-7/12 | lg:w-6/12 lg:ms-12  lg:px-8 lg:py-20 rounded-3xl bg-primary  '>
