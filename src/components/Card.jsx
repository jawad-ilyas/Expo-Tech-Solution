...
function Card({ title, description, animation, image, hoverOrNot, imageBg }) {
    return (
        <div className={`bg-lightBg ${hoverOrNot === false ? "" : " hover:bg-primary group"}  hover:cursor-pointer lg:px-10 lg:py-12 rounded-3xl flex flex-col justify-between n0 | px-4 py-6 | dark:bg-darkbg dark:hover:bg-primary dark:group` }>
