...
function AchievementsSection() {
    return (
        <div className='xl:w-11/12 xl:mx-auto  2xl:w-8/12 lg:mx-5   lg:px-28 lg:py-16 lg:mt-12 lg:mb-16  bg-lightBg   no | w-full flex flex-row flex-wrap justify-between items-center   rounded-3xl my-8 p-4  mx-2 | sm:mx-2'
            style={{
                width: 'calc(100% - 12px)',
